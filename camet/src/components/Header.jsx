...
import * as H from "../styles/Header.module.css";
  ...
  return (
    <>
      ...
      <div className={nav ? H.navMenuActive : H.navMenu}>
        ...
        <div className={H.socialMediaContainer}>
          <p>Seguinos en nuestras redes</p>
          <div className={H.socialMedia}>
            <a
              target="_blank"
              href="https://www.instagram.com/camet.galletitas/"
            >
              <svg
            ...
            <a
              target="_blank"
              href="https://www.facebook.com/profile.php?id=61550230102122"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
      ...
      <div className={nav ? H.background : H.hiddenBackground}></div>
    </>
  );
}
